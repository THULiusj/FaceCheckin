...
namespace CameraFaceDetection
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private static readonly Guid RotationKey = new Guid();

        Uri uploadAddressUri = new Uri(Config.uploadAddress);
        ...
        private bool _isSendingPhoto = false;
        ...
        /// <summary>
        /// This function is the action for face detection pushed.
        /// </summary>
        /// <param name="sender">The event source.</param>
        /// <param name="args">The event data.</param>
        ...
        /// <summary>
        /// This function is to add highlight rectangle when detected faces.
        /// </summary>
        /// <param name="sender">The event source.</param>
        /// <param name="args">The event data.</param>
        ...
        private async Task<HttpResponseMessage> httpPostRequest(byte[] bytes)
        {
            try
            {
                HttpClient request = new HttpClient();
                request.BaseAddress = uploadAddressUri;
                request.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/octet-stream"));
                HttpContent requestContent = new ByteArrayContent(bytes);
                HttpResponseMessage response = await request.PostAsync(uploadAddressUri, requestContent);
        ...
        private async Task SetPreviewRotationAsync()
        {
            ...
            MediaCaptureSettings mediaSetting = _mediaCapture.MediaCaptureSettings;
        ...
        {
            var result = await Windows.System.Launcher.LaunchUriAsync(new Uri("legoproject://"));
